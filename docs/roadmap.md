...
Estado general: **FASE 23 COMPLETADA · FASE 24 COMPLETADA · FASE 25 COMPLETADA · FASE 26 COMPLETADA · FASE 27 COMPLETADA · FASE 28 COMPLETADA · FASE 29 COMPLETADA · FASE 30 COMPLETADA (U1/U2/U3/U4/U5-A/U5-B/U5-C/U5-D/U5-E COMPLETADAS) · FASE 31 COMPLETA LOCALMENTE (U1/U2/U3/U4/U5/U6; pendiente revisión global) · FASE 32 COMPLETADA/PUBLICADA (U1: deterministic message ordering) · FASE 33 COMPLETE + VALIDATED + PUBLISHED (U1-U6) · FASE 34 COMPLETE + VALIDATED + PUBLISHED (U1-U6) · FASE 36 COMPLETE + VALIDATED + PUBLISHED (U1-U8) · FASE 37 COMPLETE + VALIDATED + PUBLISHED (FREE CONDITIONAL GO / PAID NO-GO) · FASE 39 COMPLETE + VALIDATED + PUBLISHED (Production Contract Hardening) · FASE 40 OPEN (Infrastructure Selection & Owner Decisions) · FASE 42 COMPLETE + VALIDATED + PUBLISHED (Platform Admin Customer Operations MVP) · FASE 43 COMPLETE + VALIDATED + PUBLISHED (Spanish UI and dynamic public pricing)**.
...
| 42 | Platform Admin Customer Operations MVP | COMPLETE + VALIDATED + PUBLISHED |
| 43 | Spanish UI and dynamic public pricing | COMPLETE + VALIDATED + PUBLISHED |
...
- **Producción**: el validador rechaza Mailpit, hosts SMTP locales/loopback y transporte SMTP sin
  `tls`/`smtps`. Los secretos se inyectan desde el secret manager, nunca desde Git.
- **Free-only beta**: Mail es obligatorio; Meta se activa por conexión WABA del tenant; OpenAI queda
  condicionado por entitlement; Stripe permanece opcional y sin catálogo/precios pagos; Sentry es
  opcional y DSN-gated.
